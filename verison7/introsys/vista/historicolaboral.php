...
<head>
	...
	<link rel="stylesheet" href="historicolaboral.css">
	...
	<div class="articulo">
		...
		<div class="tabla">
			<table>
				<thead>
					<tr>
						<th class="numero" >N°R</th>
						<th class="documento" >Cargo</th>
						<th class="fechaing">Fecha Ingreso</th>
						<th class="fechaculm">Fecha de Culminación</th>
